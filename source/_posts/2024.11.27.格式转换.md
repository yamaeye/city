...
- class_name:  格式转换
  link_list:
    ...
    - name: Office Converter
      ...
      avatar: https://t3.gstatic.cn/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&size=128&url=https://cn.office-converter.com/
      descr: 文件转换器
    - name: CloudConvert
    ...
    - name: 迅捷PDF转换器免费版
      ...
      avatar: https://t3.gstatic.cn/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&size=128&url=https://app.xunjiepdf.com/
      descr: PDF转换成Word转换器在线免费
{% endflink %}